...
namespace BE {
    ...
    public class BuildingDef {
        ...
        {
            BuildingDefInit(_HitPoint, _BuildGoldPrice, _BuildElixirPrice, _BuildGemPrice, _BuildTime, _LevelRequired, 0, 0);
        }
        ...
        {
            BuildingDefInit(_HitPoint, _BuildGoldPrice, _BuildElixirPrice, _BuildGemPrice, _BuildTime, _LevelRequired, _RankRequired, 0);
        }

        public BuildingDef(int _HitPoint, int _BuildGoldPrice, int _BuildElixirPrice, int _BuildGemPrice, int _BuildTime, int _LevelRequired, int _RankRequired, int _SoulProductionInc)
        {
            BuildingDefInit(_HitPoint, _BuildGoldPrice, _BuildElixirPrice, _BuildGemPrice, _BuildTime, _LevelRequired, _RankRequired, _SoulProductionInc);
        }

        public void BuildingDefInit(int _HitPoint, int _BuildGoldPrice, int _BuildElixirPrice, int _BuildGemPrice, int _BuildTime, int _LevelRequired, int _RankRequired, int _SoulProductionInc)
        {
            HitPoint = _HitPoint;
    ...
    public class TBDatabase : MonoBehaviour {
        ...
        void Awake() {
            ...
            //3 - Gold (DEMON OR HELLFIRE) GENERATOR
            {
                ...
                //for (int i = 0; i <= GLOBALS.s.BUILDING_MAX_LEVEL; i++) { 
                { BuildingDef bd = new BuildingDef(400, 100, 0, 1, 5, 0, 1); bd.SetCapacity(100 * 12, 0); bd.SetProduction(PayType.Gold, 60); bt.Add(bd); }
            ...
            //4 - Hell's Gate (Old Elixir Collector)
            {
                ...
                //for (int i = 0; i <= GLOBALS.s.BUILDING_MAX_LEVEL; i++) { 
                { BuildingDef bd = new BuildingDef(400, 100, 0, 0, 5, 0, 1); bd.SetCapacity(0, 100 * 12); bd.SetProduction(PayType.Elixir, 100); bt.Add(bd); }
            ...
            //11 - Bad Food Restaurant
            {
                ...
                { BuildingDef bd = new BuildingDef(250, 125, 0, 1, 5, 0, 1); bd.SetStorageCapacity(0, 175); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 250, 0, 2, 30, 0, 2); bd.SetStorageCapacity(0, 350); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 650, 0, 3, 60, 0, 2); bd.SetStorageCapacity(0, 600); bt.Add(bd); } //20
            ...
            //12 - Cauldron
            {
                ...
                { BuildingDef bd = new BuildingDef(250, 150, 0, 1, 5, 0, 1); bd.SetStorageCapacity(0, 200); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 400, 0, 2, 30, 0, 2); bd.SetStorageCapacity(0, 450); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 900, 0, 3, 60, 0, 2); bd.SetStorageCapacity(0, 700); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 1250, 0, 4, 2 * 60, 0, 3); bd.SetStorageCapacity(0, 1000); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 3300, 0, 5, 3 * 60, 0, 4); bd.SetStorageCapacity(0, 1250); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 8900, 0, 6, 5 * 60, 0, 5); bd.SetStorageCapacity(0, 1500); bt.Add(bd); } //20
                Buildings.Add(bt);
            }
            ...
            //13 - Sisyphus Hill
            {
                ...
                { BuildingDef bd = new BuildingDef(250, 200, 0, 1, 10, 0, 3); bd.SetStorageCapacity(0, 250); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 500, 0, 2, 40, 0, 3); bd.SetStorageCapacity(0, 500); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 1050, 0, 3, 60, 0, 3); bd.SetStorageCapacity(0, 800); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 1250, 0, 4, 2 * 60, 0, 3); bd.SetStorageCapacity(0, 750); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 3300, 0, 5, 3 * 60, 0, 4); bd.SetStorageCapacity(0, 1000); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 8900, 0, 6, 5 * 60, 0, 5); bd.SetStorageCapacity(0, 1250); bt.Add(bd); } //20
                Buildings.Add(bt);
            ...
            //14 - Toaster Oven
            {
                ...
                { BuildingDef bd = new BuildingDef(250, 100, 0, 1, 5, 0, 4); bd.SetStorageCapacity(0, 300); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 300, 0, 2, 30, 0, 4); bd.SetStorageCapacity(0, 600); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 750, 0, 3, 60, 0, 4); bd.SetStorageCapacity(0, 1000); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 1250, 0, 4, 2 * 60, 0, 4); bd.SetStorageCapacity(0, 1500); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 3300, 0, 5, 3 * 60, 0, 4); bd.SetStorageCapacity(0, 1000); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 8900, 0, 6, 5 * 60, 0, 5); bd.SetStorageCapacity(0, 1250); bt.Add(bd); } //20
                Buildings.Add(bt);
            }
            //15 - Justin Biba
            {
                ...
                { BuildingDef bd = new BuildingDef(250, 100, 0, 1, 5, 0, 1); bd.SetStorageCapacity(0, 150); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 200, 0, 2, 30, 0, 2); bd.SetStorageCapacity(0, 300); bt.Add(bd); } //20
            ...
            //16 - Fire Pool
            {
                ...
                { BuildingDef bd = new BuildingDef(250, 100, 0, 1, 5, 0, 5); bd.SetStorageCapacity(0, 100); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 300, 0, 2, 30, 0, 5); bd.SetStorageCapacity(0, 250); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 750, 0, 3, 60, 0, 5); bd.SetStorageCapacity(0, 500); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 1250, 0, 4, 2 * 60, 0, 5); bd.SetStorageCapacity(0, 750); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 3300, 0, 5, 3 * 60, 0, 5); bd.SetStorageCapacity(0, 1000); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 8900, 0, 6, 5 * 60, 0, 5); bd.SetStorageCapacity(0, 1250); bt.Add(bd); } //20
                Buildings.Add(bt);
            }
            //17 - Office
            {
                ...
                { BuildingDef bd = new BuildingDef(250, 100, 0, 1, 5, 0, 6); bd.SetStorageCapacity(0, 100); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 300, 0, 2, 30, 0, 6); bd.SetStorageCapacity(0, 250); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 750, 0, 3, 60, 0, 6); bd.SetStorageCapacity(0, 500); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 1250, 0, 4, 2 * 60, 0, 6); bd.SetStorageCapacity(0, 750); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 3300, 0, 5, 3 * 60, 0, 6); bd.SetStorageCapacity(0, 1000); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 8900, 0, 6, 5 * 60, 0, 6); bd.SetStorageCapacity(0, 1250); bt.Add(bd); } //20
                Buildings.Add(bt);
            }
            ...
            //18 - Law School
            {
                ...
                { BuildingDef bd = new BuildingDef(250, 100, 0, 0, 5, 1, 3, 5); bd.SetStorageCapacity(0, 100); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 300, 0, 0, 10, 1, 3, 10); bd.SetStorageCapacity(0, 250); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 750, 0, 0, 30, 1, 3, 20); bd.SetStorageCapacity(0, 500); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 1250, 0, 0, 60, 1, 3, 40); bd.SetStorageCapacity(0, 750); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 3300, 0, 0, 2 * 60, 0, 4, 60); bd.SetStorageCapacity(0, 1000); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 8900, 0, 0, 5 * 60, 0, 5, 80); bd.SetStorageCapacity(0, 1250); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 8900, 0, 0, 10 * 60, 0, 6, 100); bd.SetStorageCapacity(0, 1250); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 8900, 0, 0, 15 * 60, 0, 6, 125); bd.SetStorageCapacity(0, 1250); bt.Add(bd); } //20
                { BuildingDef bd = new BuildingDef(250, 8900, 0, 0, 20 * 60, 0, 7, 150); bd.SetStorageCapacity(0, 1250); bt.Add(bd); } //20
                Buildings.Add(bt);
            }
            //19 - Statue
            {
            ...
            //22 - FIRE) GENERATOR Refinery
            {
                ...
                { BuildingDef bd = new BuildingDef(480, 500, 0, 0, 30, 2, 8); bd.SetCapacity(180 * 36, 0); bd.SetProduction(PayType.Gold, 180); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 1000, 1000, 0, 60, 2, 9); bd.SetCapacity(250 * 48, 0); bd.SetProduction(PayType.Gold, 250); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 1600, 700, 0, 2 * 60, 2, 10); bd.SetCapacity(550 * 60, 0); bd.SetProduction(PayType.Gold, 550); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 4400, 700, 0, 5 * 60, 3, 11); bd.SetCapacity(850 * 80, 0); bd.SetProduction(PayType.Gold, 850); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 11000, 700, 0, 10 * 60, 3, 12); bd.SetCapacity(1300 * 100, 0); bd.SetProduction(PayType.Gold, 1300); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 31600, 700, 0, 15 * 60, 4, 13); bd.SetCapacity(3600 * 120, 0); bd.SetProduction(PayType.Gold, 3600); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 84000, 700, 0, 20 * 60, 4, 14); bd.SetCapacity(9700 * 150, 0); bd.SetProduction(PayType.Gold, 9700); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 224000, 700, 0, 30 * 60, 5, 15); bd.SetCapacity(26000 * 180, 0); bd.SetProduction(PayType.Gold, 26000); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 600000, 700, 0, 45 * 60, 5, 16); bd.SetCapacity(71000 * 210, 0); bd.SetProduction(PayType.Gold, 71000); bt.Add(bd); }
            ...
            //23 - Fire Factory
            {
                ...
                { BuildingDef bd = new BuildingDef(480, 500, 0, 0, 30, 2,6); bd.SetCapacity(180 * 36, 0); bd.SetProduction(PayType.Gold, 180); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 1000, 1000, 0, 60, 2,7); bd.SetCapacity(250 * 48, 0); bd.SetProduction(PayType.Gold, 250); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 1600, 700, 0, 2 * 60, 2,8); bd.SetCapacity(550 * 60, 0); bd.SetProduction(PayType.Gold, 550); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 4400, 700, 0, 5 * 60, 3,9); bd.SetCapacity(850 * 80, 0); bd.SetProduction(PayType.Gold, 850); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 11000, 700, 0, 10 * 60, 3,10); bd.SetCapacity(1300 * 100, 0); bd.SetProduction(PayType.Gold, 1300); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 31600, 700, 0, 15 * 60, 4,11); bd.SetCapacity(3600 * 120, 0); bd.SetProduction(PayType.Gold, 3600); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 84000, 700, 0, 20 * 60, 4,12); bd.SetCapacity(9700 * 150, 0); bd.SetProduction(PayType.Gold, 9700); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 224000, 700, 0, 30 * 60, 5,13); bd.SetCapacity(26000 * 180, 0); bd.SetProduction(PayType.Gold, 26000); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 600000, 700, 0, 45 * 60, 5,14); bd.SetCapacity(71000 * 210, 0); bd.SetProduction(PayType.Gold, 71000); bt.Add(bd); }
                { BuildingDef bd = new BuildingDef(480, 1600200, 700, 0, 1 * 60 * 60, 6,15); bd.SetCapacity(191000 * 240, 0); bd.SetProduction(PayType.Gold, 191000); bt.Add(bd); }
                Buildings.Add(bt);
            }
