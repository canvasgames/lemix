...
public class DeltaDNAExample : MonoBehaviour {
	...
	public const string ENVIRONMENT_KEY =   "27003005316841058648017035714461";
	public const string COLLECT_URL = "http://collect7079lmxwq.deltadna.net/collect/api";
	public const string ENGAGE_URL = "http://engage7079lmxwq.deltadna.net";
